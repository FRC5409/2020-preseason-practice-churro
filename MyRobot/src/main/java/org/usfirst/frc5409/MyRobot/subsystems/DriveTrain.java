...
public class DriveTrain extends Subsystem {
    ...
    private WPI_VictorSPX mot_rightDrive_VictorSPX_C21;
    ...
    public DriveTrain() {
        ...
        mot_rightDrive_VictorSPX_C21 = new WPI_VictorSPX(21);
        
        
        
        differentialDrive = new DifferentialDrive(mot_leftDrive_VictorSPX_C20, mot_rightDrive_VictorSPX_C21);
    ...
    public void setLeftMotor(double speed){
        // one speed value must be inverted so both motors move in the same direction
        mot_leftDrive_VictorSPX_C20.set(ControlMode.PercentOutput, -speed);
    }
    //sets right motor speed
    public void setRightMotor(double speed){
        mot_rightDrive_VictorSPX_C21.set(ControlMode.PercentOutput,speed);
    }
