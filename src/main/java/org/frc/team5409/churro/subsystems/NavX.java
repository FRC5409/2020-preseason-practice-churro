...
public class NavX implements Subsystem {
    ...
    public YPRHData getYPRH() {
        ...
        m_navx_com.read(RegMap.REGS_YPRH_DATA, data);
    ...
    public GXYZData getGXYZ() {
        ...
        m_navx_com.read(RegMap.REGS_GXYZ_DATA, data);
    ...
    public QXYZWData getQXYZW() {
        ...
        m_navx_com.read(RegMap.REGS_QWXYZ_DATA, data);
    ...
    public IVXYZData getIVXYZ() {
        ...
        m_navx_com.read(RegMap.REGS_IVXYZ, data);
